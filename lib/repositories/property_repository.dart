          ...
          for (final rawItem in (response as List)) {
            ...
            mappedList.add(
              PropertyModel(
                ...
                fuelType: meta['fuelType']?.toString(),
                transmission: meta['transmission']?.toString(),
                bodyType: meta['bodyType']?.toString(),
                color: meta['color']?.toString(),
                documentation: meta['documentation']?.toString(),
                houseType: meta['houseType']?.toString(),
                houseCondition: meta['houseCondition']?.toString(),
                images:
                    (map['images'] as List?)
                        ?.map((e) => e.toString())
                        .toList() ??
